...
<article <?php post_class('motopress-thumbnail-left motopress-column-layout'); ?>>

    <div class="motopress-posts-grid-thumbnail-wrapper">
        <?php
    ...
    <div class="motopress-posts-grid-extras-wrapper">
        <?php
        ...
        if( $drinksNumber ): ?>
            <div class="motopress-posts-grid-meta__drinks">
